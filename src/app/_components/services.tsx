...
const services = [
  {
    ...
    price: 'R$ 50',
    icon: <Scissors />,
    linkText: 'Olá, vi no site sobre o Banho e Tosa e gostaria de mais informações sobre.'
  },
  {
    ...
    price: "R$ 45",
    icon: <Syringe />,
    linkText: 'Olá, vi no site sobre a Consulta Veterinária e gostaria de mais informações sobre.'
  },
  {
    title: "Táxi Pet",
    ...
    price: "R$ 80",
    icon: <CarTaxiFront />,
    linkText: "Olá, vi no site sobre Hotel para pets e gostaria de mais informações sobre."
  },
  {
